    ...
    return (
      <View
        style={{ height: 8, width: 8,
          backgroundColor: result === "w" ? "green" : result === "d" ? "grey" : "red",
          margin: 0.25,
          borderWidth: 1, borderColor: 'black', borderRadius: 100
        }}
      ></View>
    );
  }
    ...
    return (
        <View style={{flex: 1, flexDirection: 'row', justifyContent: 'center'}}>
            ...
            <View style={[SmallTableDesign.statDesign, {flex: StatFlexSizes.team}]}>
                ...
                <View  style={[SmallTableDesign.separationTopBottom, {flexDirection: 'row', justifyContent: 'space-evenly'}]}>
                    <Image source={{uri: Team.image }} style={{width: 15, height: 'auto'}} />
                    <Text style={[SmallTableDesign.teamBasicText, { maxWidth: 100, marginLeft: 5, marginRight: 5}]}>{Team.name}</Text>
                </View>
            </View>

            {/* Results: W, D, L */}
            <View style={[SmallTableDesign.statDesign, {flex: StatFlexSizes.results}]}>
                <View style={[SmallTableDesign.separationTopBottom, {flexDirection: 'row', justifyContent: 'space-around'}]}>
            ...
            {/* Points */}
            <View style={[SmallTableDesign.statDesign, {flex: StatFlexSizes.points}]}>
                <View  style={SmallTableDesign.separationTopBottom}>
