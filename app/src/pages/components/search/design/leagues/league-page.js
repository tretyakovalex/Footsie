...
export default function LeaguePage({League}) {
    ...
    return (
        <View style={{flex: 1}}>
            ...
            <DropdownButton Placeholder={League.statistics} Title={"Select League Statistics"} setStatStatus={setStatisticStatus} setChosenStatistic={setChosenStatistic} />

            {statisticStatus ? <LeagueStatistics Placeholder={League.statistic[chosenStatistic]} setStatStatus={setStatisticStatus} />
             : <></>}
