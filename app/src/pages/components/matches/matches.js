...
import {
  MatchFoundation,
  LeagueFoundation,
} from '../../../styles/main-styles/matches/foundation';
...
export const Leagues = [
  ...
  },
  {
    ...
    country: 'Brazil',
    apiName: 'Campeonato Brasileiro Série B',
    matches: [],
    logo: '',
  },
  {
  ...
  {
    league: 'UEFA Europa League Conference',
    country: 'World',
    apiName: 'UEFA Europa League Conference',
    matches: [],
    logo: '',
  },
  {
...
function SortMatches(API_Match) {
  ...
  if (!matchFound) {
    Leagues.find(
      (league) => league.league === 'Rest Of The World',
    ).matches.push(API_Match);
  }
}
...
function ShowTime({ match }) {
  ...
  if (
    ...
    return (
      <Animated.Text
        style={[MatchFoundation.matchInformation.score, { opacity: fadeAnim }]}
      >
...
function MatchStart({ match }) {
  if (match.fixture.status.long === 'Not Started') {
    ...
    return (
      <Text
        style={[MatchFoundation.matchInformation.startTime, { marginTop: 5 }]}
      >
        {formatTime}
      </Text>
    );
      ...
      <Pressable style={MatchFoundation.secondContainer} onPress={handlePress}>
        ...
        <View style={MatchFoundation.home}>
          <Image
            ...
            style={MatchFoundation.home.logo}
          />
          <Text
            style={[
        ...
        <View style={MatchFoundation.matchInformation.container}>
          <Text style={MatchFoundation.matchInformation.time}>
        ...
        <View style={MatchFoundation.away}>
          ...
          <Image
            ...
            style={MatchFoundation.away.logo}
          />
        </View>
      </Pressable>
        ...
        if (league.matches.length > 0) {
          return (
            <View style={{ marginBottom: 20 }} key={index}>
              <View
                style={[
                  LeagueFoundation.container,
                  LeagueFoundation.leagueContainer,
                ]}
              >
